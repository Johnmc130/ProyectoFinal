 ...
 * @author EDU
 */
public class EliminarFuentePoder extends javax.swing.JFrame {

    /**
     * Creates new form EliminarFuentePoder
     */
    public EliminarFuentePoder() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 190, 642, 397));
        ...
        jLabel20.setText("Fuente Poder");
        jPanel4.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 10, 460, 90));

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 110));

        jLabel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 193, 159, 159));

        btnBuscareliminarproc.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        btnBuscareliminarproc.setText("Buscar");
        jPanel1.add(btnBuscareliminarproc, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, -1, -1));

        txtbuscareliminarproc.setFont(new java.awt.Font("Montserrat", 0, 18)); // NOI18N
        txtbuscareliminarproc.setBorder(null);
        jPanel1.add(txtbuscareliminarproc, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 140, 210, 40));

        btnEliminar.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        btnEliminar.setText("Eliminar");
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 370, -1, -1));
